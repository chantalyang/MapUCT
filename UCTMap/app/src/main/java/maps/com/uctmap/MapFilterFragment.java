 ...
 */
public class MapFilterFragment extends Fragment implements GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerClickListener {
    ...
    List<Icon> iconList = new ArrayList<Icon>(); //Array of Icons
     ...
     * number.
     */
    public static MapFilterFragment newInstance(int sectionNumber) {
...
/////----------------------------------Zooming camera to position user-----------------
    ...
    public void onResume() {
        Toast.makeText(getActivity(), "Tap the options menu to filter",
    ...
    public void filterByFaculty(String f) {
        for (int k = 0; k < buildings.size(); k++) {
            ...
            if (buildings.get(k).faculty.equals(f) == false) //If building not in faculty
                buildings.get(k).hidePolygon(); //Hide polygon
        }
    }
     ...
     */
    public void filterByIcon(String t) {
        for (int i = 0; i < iconList.size(); i++) {
            if (iconList.get(i).getIconType().equals(t) == false) //If not of sepcified type
                iconList.get(i).hideIcon(); //Hide icon
        }
    }

    /*
        Reset polygons for buildings
     */
    public void reset() {
        for (int k = 0; k < buildings.size(); k++) {
    ...
    /*
     Event for filtering options menu
     */
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.show_all:
                ...
                displayAllIcons();
                return true;
            case R.id.all_buildings:
                Toast.makeText(getActivity().getApplicationContext(),
                        "Displaying all buildings.", Toast.LENGTH_LONG)
                        .show();
                reset();
                return true;
            case R.id.Commerce:
                Toast.makeText(getActivity().getApplicationContext(),
                        "Displaying all Commerce faculty buildings.", Toast.LENGTH_LONG)
                        .show();
                reset();
                filterByFaculty("Commerce");
                if (item.isChecked())
            ...
            case R.id.Science:
                Toast.makeText(getActivity().getApplicationContext(),
                        "Displaying all Science faculty buildings.", Toast.LENGTH_LONG)
                        .show();
                reset();
                filterByFaculty("Science");
                if (item.isChecked())
                    item.setChecked(false);
                else item.setChecked(true);
                return true;
            ...
            case R.id.EBE:
                Toast.makeText(getActivity().getApplicationContext(),
                        "Displaying all EBE buildings.", Toast.LENGTH_LONG)
                        .show();
                reset();
                filterByFaculty("Engineering and Built Environment");
                if (item.isChecked())
                    item.setChecked(false);
                else item.setChecked(true);
                return true;
            ...
            case R.id.Humanities:
                Toast.makeText(getActivity().getApplicationContext(),
                        "Displaying all Humanities buildings.", Toast.LENGTH_LONG)
                        .show();
                reset();
                filterByFaculty("Humanities");
                if (item.isChecked())
                    item.setChecked(false);
                else item.setChecked(true);
                return true;
            ...
            case R.id.all_icons:
                Toast.makeText(getActivity().getApplicationContext(),
                        "Displaying all points of interest.", Toast.LENGTH_LONG)
                        .show();
                displayAllIcons();
                return true;
            case R.id.Food: //Reshow icons then filter
                displayAllIcons();
                Toast.makeText(getActivity().getApplicationContext(), "Displaying all food places.", Toast.LENGTH_LONG).show();
                filterByIcon("food");
                if (item.isChecked())
                    item.setChecked(false);
                else item.setChecked(true);
                return true;
            case R.id.ATMs:
                displayAllIcons(); //Reshow icons then filter
                Toast.makeText(getActivity().getApplicationContext(), "Displaying all ATMs.", Toast.LENGTH_LONG).show();
                filterByIcon("atm");
                if (item.isChecked())
                    item.setChecked(false);
                else item.setChecked(true);
                return true;
            case R.id.JammieStop:
                displayAllIcons(); //Reshow icons then filter
                Toast.makeText(getActivity().getApplicationContext(), "Displaying all Jammie stops.", Toast.LENGTH_LONG).show();
                filterByIcon("jammie");
                if (item.isChecked())
                    item.setChecked(false);
                else item.setChecked(true);
